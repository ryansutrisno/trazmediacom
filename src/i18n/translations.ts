    ...
    portfolio: {
      ...
      projects: [
        ...
        },
        {
          slug: 'vapor-pos',
          title: 'VaporPOS',
          tagline: 'Aplikasi Point of Sale modern dengan Laravel',
          description: 'Aplikasi kasir dan manajemen inventori yang dibangun dengan Laravel, di-deploy di Vercel. Cocok untuk UMKM dan toko retail.',
          tech: ['Laravel', 'PHP', 'MySQL', 'Vercel'],
    ...
    portfolio: {
      ...
      projects: [
        ...
        },
        {
          slug: 'vapor-pos',
          title: 'VaporPOS',
          tagline: 'Modern Point of Sale application with Laravel',
          description: 'A POS and inventory management application built with Laravel, deployed on Vercel. Suitable for UMKM and retail stores.',
          tech: ['Laravel', 'PHP', 'MySQL', 'Vercel'],
          image: '/project-images/Thumbnail-Vapor-POS.png',
          url: 'https://vapor-pos.vercel.com',
          category: 'Web Apps',
